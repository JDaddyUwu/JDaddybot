	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				foto: 'Calma estoy cambiando la foto de perfil del grupo\n\nPor favor no hacer spam👏\n\n_*by 🍒𝘿𝙖𝙙𝙙𝙮🍒*_',
			...
			const ownerNumber = ["13399999999@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '13399999999@s.whatsapp.net'
...
susp = `『 BANEADO 🚫 』\n\n◉Nombre: @${mentioned[0].split('@')[0]}\n◉Razon: Spam\n\n*Usted a sido baneado por pendejo, no podra usar el bot hasta nuevo aviso*`
		...
		if (!isUser) return reply(mess.only.daftarB)
			...
			case 'todos':
				...
				client.updatePresence(from, Presence.composing) 
					...
					mentions('╔══✪〘 *TODOS* 〙✪══\n╠➥'+teks+'╚═〘 _*by 🍒𝘿𝙖𝙙𝙙𝙮🍒*_ 〙', members_id, true)
					break
                                case 'send':
					var pc = body.slice(6)
